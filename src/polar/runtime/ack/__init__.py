...
This package also hosts :mod:`polar.runtime.ack.e2b`, the ``e2b`` backend, which
drives a self-hosted sandbox plane through the E2B SDK and needs only the ``e2b``
extra. The re-exports below are therefore lazy: importing a submodule must not
drag in ``kubernetes``.
"""
...
_LAZY_EXPORTS = {
    "ACKRuntime": "polar.runtime.ack.runtime",
    "KubernetesClientManager": "polar.runtime.ack.client",
    "_CLAIM_NAME_LABEL": "polar.runtime.ack._sdk",
    "_POD_LABELS": "polar.runtime.ack._sdk",
    "_SANDBOX_API_VERSION": "polar.runtime.ack._sdk",
}
...
def __getattr__(name: str) -> Any:
    """Resolve a re-export on first use, so the ``ack`` extra stays optional."""
